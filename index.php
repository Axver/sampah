                            ...
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                  ...
                                  <div id="input">
                                     ...
                                     <input id="lat" disabled name="lat" type="text">
                                     <label for="lon">Longitude :</label>
                                     <input id="lon" disabled name="lon" type="text">
                                ...
                                <div class="card-footer ">
                                    ...
                                    <hr>
                                    <div class="stats">
                                     <button style="margin-top:40px;" type="button" class="btn btn-sucess" name="button">Inputkan data</button>
                                    </div>
                                </div>
                            </div>
                        </div>
